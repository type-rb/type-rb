...
func (g *generator) intrinsic(name string, call *ir.Call, arguments []string) string {
	...
	case "trb.std.arrays.pop":
		return "((): " + callType + " => { const value = " + arguments[0] + ".pop(); if (value === undefined) { throw new Error(\"Array is empty\"); } return value; })()"
	case "trb.std.arrays.shift":
		return "((): " + callType + " => { const value = " + arguments[0] + ".shift(); if (value === undefined) { throw new Error(\"Array is empty\"); } return value; })()"
