...
func TestReplExecutesPortableORMReads(t *testing.T) {
	...
	want := strings.Join([]string{
		...
		`DbResult::Ok(value: 1) : DbResult<Integer>`,
		`DbResult::Ok(value: 1) : DbResult<Integer>`,
		`DbResult::Ok(value: 14) : DbResult<Integer>`,
