...
Diagnostics, completion, hover information, signature help, formatting, and
quick fixes therefore use the same compiler service as the CLI instead of
editor-specific language logic.
